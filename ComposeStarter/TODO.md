...
- `app/src/test/java/presentation/GreetingScreenTest.kt`
- `app/src/test/java/presentation/ListScreenTest.kt`
- `app/src/test/java/presentation/SampleDialogTest.kt`
...
- **Replace `AppScaffold`**: Tests currently use
  ...
  Material 3 `androidx.wear.compose.material3.AppScaffold`.
- **Replace `ResponsiveTimeText`**: Use the native `androidx.wear.compose.material3.TimeText`
  instead of Horologist's version.
